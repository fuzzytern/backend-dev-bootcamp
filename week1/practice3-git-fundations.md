...
* Fork an existing repository of your choice from `iteratehackerspace` and perform a change you think meaningful. An easy change could be fixing a repo in this lecture markdown file. Work in a separate branch of your repo1, then push it to your upstream repository.
